...
UCLASS(config=Game)
class ASelfDrivingCarPawn : public AWheeledVehicle
{
	GENERATED_BODY()
...
public:
	...
	/** ------------*/
	UPROPERTY(Category = Control, EditAnyWhere, BlueprintReadOnly)
	float ThrottleScale;
...
public:
	...
	//-------------
	void IncreaseThrottleScale();
	//-------------
	void DecreaseThrottleScale();
